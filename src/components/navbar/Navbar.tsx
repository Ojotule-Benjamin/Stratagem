    ...
    <div className=" bg-primary_color_white w-full h-28 md:h-[120px] py-0 md:py-1 lg:py-1 px-2 md:px-5 lg:px-9 flex items-center justify-between">
      ...
      <ul className="hidden lg:flex items-center justify-center gap-4">
        {navLinks.map((link) => {
          return (
            <li key={link.name}>
              <p className=" flex font-outfit font-normal text-lg text-text_color_blackII leading-6 cursor-pointer">
                {link.name}
              </p>
      ...
      {/* <button className="hidden w-52 h-12 py-3 px-7 text-text_color_white bg-primary_color lg:flex items-center justify-center font-outfit font-medium text-lg leading-6">
        Book Consultation
      </button> */}
      <Button
